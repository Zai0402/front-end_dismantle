    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-100 mt-12 sm:mt-0">
      ...
      <main className="flex-1 flex flex-col">
        <header className="hidden sm:flex bg-white shadow px-6 py-4 justify-between items-center">
          <h1 className="text-xl font-bold text-gray-800">Beranda Teknisi</h1>
        ...
        <div className="p-6 flex-1">
          <div className="grid grid-cols-3 gap-4 mb-6">
            {[
              {
                label: "Proses",
                value: statusCount.proses,
                bg: "bg-yellow-100",
                text: "text-yellow-800",
              },
              {
                label: "Selesai",
                value: statusCount.selesai,
                bg: "bg-green-100",
                text: "text-green-800",
              },
              {
                label: "Hilang",
                value: statusCount.tidak_ketemu,
                bg: "bg-red-100",
                text: "text-red-800",
              },
              ...
              <div
                key={idx}
                className={`${bg} p-4 rounded shadow text-center`}
                data-aos="zoom-in"
